...
@Component
public class JwtTokenAdapter implements
        IssueAccessTokenPort,
        VerifyAccessTokenPort,
        IssueRefreshTokenPort,
        VerifyRefreshTokenPort {
    ...
    JwtTokenAdapter(JwtProperties jwtProperties, Clock clock) {
    ...
    public IssuedAccessToken issueAccessToken(AuthenticatedUserInfo user) {
        ...
        Long expiresInSeconds = jwtProperties.accessTokenExpirationSeconds();
