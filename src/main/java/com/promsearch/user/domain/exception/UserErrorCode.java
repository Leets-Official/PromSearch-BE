...
public enum UserErrorCode implements BaseCode {
    ...
    UNSUPPORTED_PROFILE_IMAGE_CONTENT_TYPE(
            HttpStatus.BAD_REQUEST,
            "USER-014",
            "프로필 이미지는 JPEG 또는 PNG만 지원합니다."
    ),
    INVALID_PROFILE_IMAGE_FILE_SIZE(
            HttpStatus.BAD_REQUEST,
            "USER-015",
            "프로필 이미지 파일 크기가 유효하지 않습니다."
    ),
    PROFILE_IMAGE_UPLOAD_NOT_FOUND(
            HttpStatus.CONFLICT,
            "USER-016",
            "S3에 업로드된 프로필 이미지가 없습니다."
    ),
    PROFILE_IMAGE_UPLOAD_METADATA_MISMATCH(
            HttpStatus.BAD_REQUEST,
            "USER-017",
            "업로드된 프로필 이미지 정보가 요청과 일치하지 않습니다."
    ),
    PROFILE_IMAGE_NOT_OWNED(
            HttpStatus.FORBIDDEN,
            "USER-018",
            "본인 경로에 업로드한 프로필 이미지만 사용할 수 있습니다."
    ),
    PROFILE_IMAGE_STORAGE_UNAVAILABLE(
            HttpStatus.SERVICE_UNAVAILABLE,
            "USER-019",
            "프로필 이미지 저장소를 사용할 수 없습니다."
    ),
    INVALID_PROFILE_IMAGE_OBJECT_KEY(
            HttpStatus.BAD_REQUEST,
            "USER-020",
            "프로필 이미지 Object Key가 유효하지 않습니다."
    );
