...
class SwaggerProdEnabledMockMvcTest {

    @Autowired
    private MockMvc mockMvc;

    @DisplayName("prod에서 Swagger 활성화 시 OpenAPI JSON은 Basic Auth로 보호된다")
    @Test
    void docsJsonProtectedByBasicAuthInProd() throws Exception {
    ...
    @DisplayName("prod Swagger Basic Auth는 일반 API에 전역 적용되지 않는다")
    @Test
