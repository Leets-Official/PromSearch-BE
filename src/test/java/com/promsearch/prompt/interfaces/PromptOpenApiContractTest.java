...
class PromptOpenApiContractTest {
    ...
    void promptQueryEndpointsAreDocumented() throws Exception {
        ...
        assertOperationMetadata(document, "/paths/~1api~1v1~1prompts~1me/get", "PROMPT-010", "kallin1", "구현완료");
        assertOperationMetadata(document, "/paths/~1api~1v1~1prompts~1me~1insights/get", "PROMPT-011", "kallin1", "구현완료");
    }
