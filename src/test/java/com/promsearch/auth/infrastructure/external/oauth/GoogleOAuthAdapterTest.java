...
class GoogleOAuthAdapterTest {
    ...
    void exchangeCodeAndFetchUserInfoSuccess() {
        ...
        GoogleOAuthAdapter adapter = new GoogleOAuthAdapter(PROPERTIES, builder);
        ...
        SocialLoginResult userInfo = adapter.exchangeCodeAndFetchUserInfo("auth-code", "https://promsearch.com/callback");

        assertThat(adapter.provider()).isEqualTo(SocialProvider.GOOGLE);
    ...
    void exchangeCodeAndFetchUserInfoFailsWhenEmailMissing() {
        ...
        assertThatThrownBy(() -> adapter.exchangeCodeAndFetchUserInfo("auth-code", "https://promsearch.com/callback"))
