...
class PostReportQueryServiceTest {
    ...
    private final PostReportQueryService postReportQueryService = new PostReportQueryService(loadPostReportPort);

    @Test
    void searchReportsMapsContentAndTotal() {
        PostReport report = PostReport.reconstruct(
                new PostReportId(1L), 5L, ReportTargetType.POST, 10L, ReportReason.SPAM, "설명",
